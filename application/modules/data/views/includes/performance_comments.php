        ...
        <table id="performance_comments" class="table table-responsive table-striped table-bordered">
            <thead>
                ...
                <tr>
                    ...
                    <th style="width:32%;"><?php echo explode("/", Modules::run('data/get_computation', $kpi_id))[0]; ?></th>
                    <th style="width:32%;"><?php echo explode("/", Modules::run('data/get_computation', $kpi_id))[1]; ?></th>
